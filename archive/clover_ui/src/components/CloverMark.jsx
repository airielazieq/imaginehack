// Clover logo mark — four rounded leaves + stem. Inherits color via `fill`.
export default function CloverMark({ className = 'h-7 w-7', title = 'Clover' }) {
  return (
    <svg viewBox="0 0 48 48" className={className} role="img" aria-label={title}>
      ...
      <path d="M24 26c1 4 1.5 9 5 13" stroke="currentColor" strokeWidth="2.4"
